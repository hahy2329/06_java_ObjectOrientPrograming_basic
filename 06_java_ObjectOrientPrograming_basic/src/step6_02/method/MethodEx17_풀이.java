...
class TicTacToe1{
	...
	//game 배열을 공백(" ")으로 초기화(초기화 하지 않을 경우 null값)
	void setGame() {
	...
	void exitCross() {
		...
		if(game[0][2].equals("X") && game[1][1].equals("X") && game[2][0].equals("X"))win =1;
	}
